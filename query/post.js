...
const findDetailPosts = (postID) => {
  return `SELECT title, post_images AS postImages, contact_number AS contactNumber, 
  post_loc_x, post_loc_y, description, address, address_short AS addressShort, post_desc AS postDesc, like_cnt AS likeCnt FROM Posts 
