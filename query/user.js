...
const getUserInformationById = (id) => {
  return `SELECT user_id AS userId, email, nickname, user_image AS userImage ,description AS mbti FROM Users INNER JOIN Mbti ON Users.mbti_id = Mbti.mbti_id WHERE user_id = ${id} `;
};
