const adminPageQuery = `
   ...
   post_loc_x, post_loc_y, like_cnt, Posts.weather_id, Weathers.description as weather, inside_yn,
   Posts.gender_id, Genders.description as gender, Posts.member_id, MemberCnt.description as member, created_at
   FROM Posts
